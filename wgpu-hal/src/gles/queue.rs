    ...
    unsafe fn process(
        ...
        match *command {
            ...
            C::SetPushConstants {
                ...
                fn get_data<T: bytemuck::AnyBitPattern>(data: &[u8], offset: u32) -> T {
                    let raw = &data[(offset as usize)..][..core::mem::size_of::<T>()];
                ...
                match uniform.utype {
                    glow::FLOAT => {
                        let data = get_data::<f32>(data_bytes, offset);
                    ...
                    glow::INT => {
                        let data = get_data::<i32>(data_bytes, offset);
                    ...
                    glow::UNSIGNED_INT => {
                        let data = get_data::<u32>(data_bytes, offset);
                        unsafe { gl.uniform_1_u32(location, data) };
                    }
                    glow::FLOAT_MAT3 => {
                        let data = get_data::<[f32; 9]>(data_bytes, offset);
